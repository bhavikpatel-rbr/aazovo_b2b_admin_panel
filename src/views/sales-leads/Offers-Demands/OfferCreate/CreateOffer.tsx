...
const CreateOffer = () => {
    ...
    const {
        usersData = [], productsMasterData = [], memberData = [], ProductsData = [], ProductSpecificationsData = [], PaymentTermsData = [],
    ...
    const dispatchStatusOptions: OptionType[] = [{ value: "Booking", label: "Booking" }, { value: "Ready Stock", label: "Ready Stock" }];
    ...
    const { control, handleSubmit, reset, watch, setValue, getValues, formState: { errors } } = useForm<OfferFormData>({
