...
// This schema is very similar to the offer form
const demandFormSchema = z.object({
  ...
  // Buyer Section first for Demand
  buyerSection: z.object({
    buyerId: z.string().optional().nullable(),
  }).optional(),

  groupA_notes: z.string().optional().nullable(), // Notes associated with the primary section (Buyer)
  ...
  groupB_notes: z.string().optional().nullable(), // Notes associated with the secondary section (Seller)
});
...
const CreateDemand = () => {
  ...
  const handleSaveAsDraft = () => { // Added Draft functionality
    const currentValues = formMethods.getValues();
    console.log("Saving as draft (Create Demand):", currentValues);
    toast.push(
        <Notification title="Draft Saved" type="info">
            Demand saved as draft. (Simulated)
        </Notification>
    );
  };
    ...
    <>
      ...
      >
            ...
            <div className="flex flex-col gap-4">
              <Card>
                ...
                <div className="mt-4 flex items-center gap-1">
                  ...
                  <Button type="button" icon={<TbTrash size={20} />} className="min-h-10 min-w-10 self-end mb-1"
                    onClick={() => formMethods.setValue('sellerSection.sellerId', '')} 
                  />
                  {/* <Button type="button" icon={<TbPlus size={20} />} className="min-h-10 min-w-10 self-end mb-1" /> */}
                </div>
                <div className="text-right mt-2">
        ...
        <Card bodyClass="flex justify-end gap-2" className='mt-4'>
          ...
          <Button type="button" onClick={handleSaveAsDraft} variant="twoTone" disabled={isSubmitting}> {/* Added Draft button */}
            Draft
          </Button>
          <Button
            type="submit"
