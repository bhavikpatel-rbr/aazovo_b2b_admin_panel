...
const EditLeadPage = () => {
    ...
    const isLoadingPage = isLoadingLeadDetails || (masterLoadingStatus === "idle" && !initialDataFetched);
                    ...
                    <AdaptableCard>
                        <h5 className="mb-6 font-semibold">Sourcing Details (Optional)</h5>
                         <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-2">
                            ...
                            <FormItem label="Product (Sourced)" error={errors.sourcing_productId?.message}><Controller name="sourcing_productId" control={control} render={({ field }) => <UiSelect placeholder="Select Product" options={productOptions} value={productOptions.find(o=>o.value===field.value)} onChange={opt=>field.onChange(opt?.value)} isLoading={masterLoadingStatus === "idle" && !initialDataFetched} isClearable />}/></FormItem>
                            <FormItem label="Product Specification" error={errors.sourcing_productSpecId?.message}><Controller name="sourcing_productSpecId" control={control} render={({ field }) => <UiSelect placeholder="Select Specification" options={productSpecOptions} value={productSpecOptions.find(o=>o.value===field.value)} onChange={opt=>field.onChange(opt?.value)} isLoading={masterLoadingStatus === "idle" && !initialDataFetched} isClearable />}/></FormItem>
                            ...
                            <FormItem label="Cartoon Type" error={errors.sourcing_cartoonTypeId?.message}><Controller name="sourcing_cartoonTypeId" control={control} render={({ field }) => <UiSelect placeholder="Select Cartoon Type" options={cartoonTypeOptions} value={cartoonTypeOptions.find(o=>o.value===field.value)} onChange={opt=>field.onChange(opt?.value)} isLoading={masterLoadingStatus === "idle" && !initialDataFetched} isClearable />}/></FormItem>
                            ...
                            <FormItem label="Payment Term" error={errors.sourcing_paymentTermId?.message}><Controller name="sourcing_paymentTermId" control={control} render={({ field }) => <UiSelect placeholder="Select Payment Term" options={paymentTermOptions} value={paymentTermOptions.find(o=>o.value===field.value)} onChange={opt=>field.onChange(opt?.value)} isLoading={masterLoadingStatus === "idle" && !initialDataFetched} isClearable />}/></FormItem>
