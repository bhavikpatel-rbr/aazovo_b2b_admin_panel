...
import {
  ...
  TbBuilding, TbBulb, TbCalendar, TbCalendarEvent, TbCancel, TbChecks, TbCircleCheck,
  TbClipboardText, TbCloudDownload, TbCloudUpload, TbCopy, TbCurrencyDollar, TbDotsVertical,
  TbDownload, TbEye, TbFileSearch, TbFileText, TbFileZip, TbFilter, TbListCheck,
  TbListDetails, TbMail, TbMessageCircle, TbPackageExport, TbPencil, TbPhoto, TbPlus,
  TbProgress, TbReceipt, TbReload, TbSearch, TbShare, TbStack2, TbTagStarred, TbUser,
  TbUserSearch, TbUsersGroup,
} from "react-icons/tb";
...
import { 
    ...
    deleteAllWallAction, 
    // submitExportReasonAction, // Assuming this is defined elsewhere or its logic is simple
...
const WallListing = () => {
  ...
  const pageData = useMemo(() => {
    return Array.isArray(wallListing?.data) ? wallListing?.data.map(mapApiToWallItem) : [];
  }, [wallListing?.data, mapApiToWallItem]);
      ...
      <Container className="h-auto">
        <AdaptiveCard className="h-full" bodyClass="h-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 mb-4 mt-4 gap-2 ">
            <Card bodyClass="flex gap-2 p-1" className="rounded-sm border border-blue-200"><div className="h-9 w-8 rounded-md flex items-center justify-center bg-blue-100 text-blue-500"><TbListDetails size={20} /></div><div className="flex flex-col"><b className="text-blue-500">{totalItems}</b><span className="font-semibold text-[11px]">Total</span></div></Card>
            <Card bodyClass="flex gap-2 p-1" className="rounded-sm border border-emerald-200"><div className="h-9 w-8 rounded-md flex items-center justify-center bg-emerald-100 text-emerald-500"><TbCalendar size={20} /></div><div className="flex flex-col"><b className="text-emerald-500">12</b><span className="font-semibold text-[11px]">Today</span></div></Card>
            <Card bodyClass="flex gap-2 p-1" className="rounded-sm border border-violet-200"><div className="h-9 w-8 rounded-md flex items-center justify-center bg-violet-100 text-violet-500"><TbBox size={20} /></div><div className="flex flex-col"><b className="text-violet-500">12</b><span className="font-semibold text-[11px]">Buy</span></div></Card>
            <Card bodyClass="flex gap-2 p-1" className="rounded-sm border border-pink-200"><div className="h-9 w-8 rounded-md flex items-center justify-center bg-pink-100 text-pink-500"><TbPackageExport size={20} /></div><div className="flex flex-col"><b className="text-pink-500">12</b><span className="font-semibold text-[11px]">Sell</span></div></Card>
            <Card bodyClass="flex gap-2 p-1" className="rounded-sm border border-green-300" ><div className="h-9 w-8 rounded-md flex items-center justify-center bg-green-100 text-green-500"><TbCircleCheck size={20} /></div><div className="flex flex-col"><b className="text-green-500">12</b><span className="font-semibold text-[11px]">Active</span></div></Card>
            <Card bodyClass="flex gap-2 p-1" className="rounded-sm border border-red-200"><div className="h-9 w-8 rounded-md flex items-center justify-center bg-red-100 text-red-500"><TbCancel size={20} /></div><div className="flex flex-col"><b className="text-red-500">12</b><span className="font-semibold text-[11px]">Non Active</span></div></Card>
            <Card bodyClass="flex gap-2 p-1" className="rounded-sm border border-orange-200"><div className="h-9 w-8 rounded-md flex items-center justify-center bg-orange-100 text-orange-500"><TbProgress size={20} /></div><div className="flex flex-col"><b className="text-orange-500">12</b><span className="font-semibold text-[11px]">Pending</span></div></Card>
