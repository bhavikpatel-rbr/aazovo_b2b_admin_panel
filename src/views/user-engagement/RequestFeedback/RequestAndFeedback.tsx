        ...
        {item.attachment ? (
          <div className="flex justify-between items-center p-3 rounded-lg bg-gray-50 dark:bg-gray-700/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-sm">{attachmentName}</p>
              </div>
            </div>
            <a
...
const statusColors: Record<RequestFeedbackApiStatus, string> = {
  ...
  "In Progress":
    "bg-cyan-100 text-cyan-600 dark:bg-cyan-500/20 dark:text-cyan-100", // Added In Progress
...
const requestFeedbackFormSchema = z.object({
  ...
  type: z.enum(typeValues, {
    // Use derived typeValues
    errorMap: () => ({ message: "Please select a type." }),
  }),
  status: z.enum(statusFormValues, {
    // Use derived statusFormValues
...
>
  ...
  {/* 7. Download Document */}
  <Dropdown.Item onClick={() => onOpenModal("document", rowData)} className="flex items-center gap-2">
  ...
  const onSubmitHandler = async (data: RequestFeedbackFormData) => {
    ...
    if (editingItem) {
      ...
      if (selectedFile instanceof File) {
        ...
        // Ensure there was an attachment to remove
      ...
      try {
        ...
        toast.push(
          <Notification title="Data Exported" type="success">
            Request & Feedback data exported.
          </Notification>
        );
        ...
        toast.push(
          <Notification
            ...
            type="danger"
            message={(error as Error).message || "Could not complete export."}
          />
        );
      } finally {
  ...
  const columns: ColumnDef<RequestFeedbackItem>[] = useMemo(
    () => [
        ...
        cell: (props) => (
          <div className="flex items-center gap-2">
            <Avatar size="sm" shape="circle" className="mr-1">
              {props.getValue<string>()?.[0]?.toUpperCase()}
            </Avatar>
      ...
      },
      {
        ...
        size: 200,
        cell: (props) => (
          <div className="truncate w-48" title={props.getValue() as string}>
  ...
  const renderDrawerForm = (currentFormMethods: typeof formMethods) => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <FormItem
        label={
          <div>
            Feedback / Request Details<span className="text-red-500"> *</span>
          </div>
        }
        className="md:col-span-2"
          ...
          <div className="mt-2 text-sm text-gray-500 flex items-center justify-between">
            <span className="truncate max-w-[calc(100%-100px)]">
              ...
              <a
                ...
                title={editingItem.attachment.split("/").pop()}
              >
  ...
  return (
    <>
        ...
        <AdaptiveCard className="h-full" bodyClass="h-full">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 mb-4 gap-2">
            <Card
              ...
              className="rounded-md border border-blue-200 dark:border-blue-700/60"
            >
              ...
              <div>
                <h6 className="text-blue-500 dark:text-blue-200">
                  {requestFeedbacksData?.counts?.total || 0}
                </h6>
            ...
            <Card
              bodyClass="flex gap-2 p-2"
              className="rounded-md border border-green-300 dark:border-green-700/60"
            >
              ...
              <div>
                <h6 className="text-green-500 dark:text-green-200">
                  {requestFeedbacksData?.counts?.unread || 0}
                </h6>
            ...
            <Card
              bodyClass="flex gap-2 p-2"
              className="rounded-md border border-pink-200 dark:border-pink-700/60"
            >
              ...
              <div>
                <h6 className="text-pink-500 dark:text-pink-200">
                  {requestFeedbacksData?.counts?.resolved || 0}
                </h6>
            ...
            <Card
              bodyClass="flex gap-2 p-2"
              className="rounded-md border border-red-200 dark:border-red-700/60"
            >
              ...
              <div>
                <h6 className="text-red-500 dark:text-red-200">
                  {requestFeedbacksData?.counts?.pending || 0}
                </h6>
            ...
            <Card
              bodyClass="flex gap-2 p-2"
              className="rounded-md border border-violet-300 dark:border-violet-700/60"
            >
              ...
              <div>
                <h6 className="text-violet-500 dark:text-violet-200">
                  {requestFeedbacksData?.counts?.avg_time || 0}
                </h6>
            ...
            <Card
              bodyClass="flex gap-2 p-2"
              className="rounded-md border border-orange-200 dark:border-orange-700/60"
            >
              ...
              <div>
                <h6 className="text-orange-500 dark:text-orange-200">
                  {requestFeedbacksData?.counts?.avg_rating || 0}
                </h6>
      ...
      >
        ...
        >
          {" "}
          {/* Increased pb for footer space */}
          {renderDrawerForm(formMethods)}
          {editingItem && (
            <div className="">
              {" "}
              {/* Ensure full width and padding consistency */}
              <div className="grid grid-cols-2 text-xs bg-gray-100 dark:bg-gray-700 p-2 rounded mt-3">
                <div>
                  <b className="mt-3 mb-3 font-semibold text-primary-600 dark:text-primary-400">
                    Latest Update:
                  </b>
                  <br />
      ...
      >
        <div className="p-1">
          <h5 className="mb-6 border-b pb-4 dark:border-gray-600">
            Details: {viewingItem?.subject || `Entry by ${viewingItem?.name}`}
          </h5>
          {viewingItem && (
                ...
                <span className="w-2/3 flex items-center gap-1">
                  {viewingItem.rating ? (
                    <>
                      ...
                      )?.label || `${viewingItem.rating} Stars`}
                    </>
                  ) : (
                    "N/A"
                  )}
