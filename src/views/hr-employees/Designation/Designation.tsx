// src/views/your-path/DesignationListing.tsx (New file name)
...
const initialDummyDesignations: DesignationItem[] = [
    { id: 'DES001', name: 'Software Engineer II' },
    { id: 'DES002', name: 'Marketing Manager' },
    { id: 'DES003', name: 'Sales Representative' },
    { id: 'DES004', name: 'HR Specialist' },
    { id: 'DES005', name: 'Logistics Coordinator' },
    { id: 'DES006', name: 'Accountant' },
    { id: 'DES007', name: 'Support Team Lead' },
    { id: 'DES008', name: 'Senior Software Engineer' },
    { id: 'DES009', name: 'Product Manager' },
    { id: 'DES010', name: 'Graphic Designer' },
    { id: 'DES011', name: 'Data Analyst' },
    { id: 'DES012', name: 'Chief Executive Officer (CEO)' },
]
// --- End Constants ---
    ...
    return (
        <>
            ...
            <ConfirmDialog
                ...
                type="danger"
                title={`Delete ${selectedDesignations.length} Designation${selectedDesignations.length > 1 ? 's' : ''}`}
        ...
        (designationToDelete: DesignationItem) => {
            ...
            toast.push(
                <Notification
                    ...
                    type="success"
                    duration={2000}
                >{`Designation '${designationToDelete.name}' deleted.`}</Notification>,
            )
        },
