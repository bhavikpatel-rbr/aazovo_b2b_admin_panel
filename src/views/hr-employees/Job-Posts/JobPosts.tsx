...
const jobPostFormSchema = z.object({
    ...
    experience: z
        ...
        .max(50, 'Experience too long (max 50 chars).'),
    vacancies: z
        .string()
    ...
    job_plateforms: z
        .array(jobPlatformSchema)
        .min(1, 'At least one job platform is required.'),
})
    ...
    const transformedRows: JobPostExportItem[] = rows.map((row) => ({
        ...
        job_department_name:
            departmentOptions.find(
                (d) => String(d.value) === String(row.job_department_id),
            )?.label || String(row.job_department_id),
                ...
                <div className="flex items-center justify-between w-full px-4 sm:px-8">
                    <span className="flex items-center gap-2">
                        ...
                        <span className="font-semibold flex items-center gap-1 text-sm sm:text-base">
                            ...
                            <span>
                                Job Post{selectedItems.length > 1 ? 's' : ''}{' '}
                                selected
                            </span>
                        </span>
                    </span>
...
const JobPostsListing = () => {
    ...
    useEffect(() => {
        if (
            ...
            !formMethods.getValues('job_department_id')
        ) {
            formMethods.setValue(
                'job_department_id',
                defaultFormValues.job_department_id,
                { shouldValidate: true },
            )
        }
    }, [
            ...
            if (item.job_plateforms) {
                ...
                if (typeof item.job_plateforms === 'string') {
                    try {
                        ...
                        console.error(
                            'Failed to parse job_plateforms string:',
                            e,
                        )
                    }
    ...
    const onConfirmSingleDelete = useCallback(async () => {
        ...
        try {
            await dispatch(
                deleteJobPostAction({ id: itemToDelete.id }),
            ).unwrap()
            toast.push(
                <Notification
                    ...
                    type="success"
                    duration={2000}
                >{`Job post "${itemToDelete.job_title || itemToDelete.id}" deleted.`}</Notification>,
            )
        ...
        try {
            ...
            toast.push(
                <Notification
                    ...
                    type="success"
                    duration={2000}
                >{`${idsToDelete.length} job post(s) deleted.`}</Notification>,
            )
            setSelectedItems([])
            dispatch(getJobPostsAction())
        } catch (error: any) {
    ...
    const { pageData, total, allFilteredAndSortedData } = useMemo(() => {
        const sourceData: JobPostItem[] = Array.isArray(jobPostsData?.data)
            ? jobPostsData?.data
            : []
        ...
        if (filterCriteria.filterDepartment?.length) {
            const deptValues = filterCriteria.filterDepartment.map(
                (d) => d.value,
            )
            processedData = processedData.filter((item) =>
    ...
    const handleConfirmExportWithReason = async (
        ...
        try {
            ...
            const exportSuccess = exportJobPostsToCsv(
                fileName,
            ...
            },
            {
                ...
                cell: (props) => {
                    ...
                    return (
                        <Tag
                            className={classNames(
                                'capitalize whitespace-nowrap min-w-[70px] text-center',
                                jobStatusColor[statusVal] ||
            ...
            <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    <FormItem
                        ...
                        invalid={
                            !!currentFormMethods.formState.errors.job_title
                        }
                        errorMessage={
                            currentFormMethods.formState.errors.job_title
                                ?.message
                    ...
                    <FormItem
                        ...
                        invalid={
                            !!currentFormMethods.formState.errors
                                .job_department_id
                        }
                        errorMessage={
                            currentFormMethods.formState.errors
                                .job_department_id?.message
                        }
                    >
                        <Controller
                    ...
                    <FormItem
                        ...
                        errorMessage={
                            currentFormMethods.formState.errors.status?.message
                        }
                    >
                        <Controller
                            name="status"
                    ...
                    <FormItem
                        ...
                        errorMessage={
                            currentFormMethods.formState.errors.location
                                ?.message
                        }
                    >
                        <Controller
                    ...
                    <FormItem
                        ...
                        invalid={
                            !!currentFormMethods.formState.errors.experience
                        }
                        errorMessage={
                            currentFormMethods.formState.errors.experience
                                ?.message
                    ...
                    <FormItem
                        ...
                        invalid={
                            !!currentFormMethods.formState.errors.vacancies
                        }
                        errorMessage={
                            currentFormMethods.formState.errors.vacancies
                                ?.message
                    ...
                    <FormItem
                        ...
                        className="md:col-span-2"
                        invalid={
                            !!currentFormMethods.formState.errors.description
                        }
                        errorMessage={
                            currentFormMethods.formState.errors.description
                                ?.message
                ...
                <div className="md:col-span-2 mt-4">
                    <div className="flex justify-between items-center mb-2">
                        <h6 className="text-gray-700 dark:text-gray-200">
                            Job Platforms
                            <span className="text-red-500"> *</span>
                        </h6>
                        <Button
                    ...
                    {currentFormMethods.formState.errors.job_plateforms &&
                        !currentFormMethods.formState.errors.job_plateforms
                            .root &&
                        !Array.isArray(
                            currentFormMethods.formState.errors.job_plateforms,
                    ...
                    {fields.map((field, index) => (
                        <div
                            key={field.id}
                            className="grid grid-cols-1 md:grid-cols-[1fr_1fr_auto_auto] gap-x-3 gap-y-2 border p-3 rounded-md mb-3 items-end"
                        >
                            <FormItem
                                label="Portal"
                                className="mb-0"
                            ...
                            >
                                <Controller
                                    name={`job_plateforms.${index}.portal`}
                                    control={currentFormMethods.control}
                            ...
                            <FormItem
                                ...
                                invalid={
                                    !!currentFormMethods.formState.errors
                                        .job_plateforms?.[index]?.link
                                }
                                errorMessage={
                                    currentFormMethods.formState.errors
                                        .job_plateforms?.[index]?.link?.message
                                }
                            >
                                <Controller
                                    name={`job_plateforms.${index}.link`}
                                    control={currentFormMethods.control}
                                    render={({ field: controllerField }) => (
                                        <Input
                                            {...controllerField}
                            ...
                            <FormItem
                                label="App. Count"
                                className="mb-0 md:w-32"
                                invalid={
                                    !!currentFormMethods.formState.errors
                                        .job_plateforms?.[index]
                                        ?.application_count
                                }
                                errorMessage={
                                    currentFormMethods.formState.errors
                                        .job_plateforms?.[index]
                                        ?.application_count?.message
                                }
                            >
                                <Controller
                                    name={`job_plateforms.${index}.application_count`}
                                    control={currentFormMethods.control}
                                    render={({ field: controllerField }) => (
                                        <Input
                                            {...controllerField}
                            ...
                            <Button
                                ...
                                className="text-red-500 self-center mb-1 md:mb-0"
                ...
                {currentEditingItem && (
                    <div className="">
                        <div className="grid grid-cols-2 text-xs bg-gray-100 dark:bg-gray-700 p-2 rounded">
                            <div>
                                <b className="font-semibold text-primary">
                                    Latest Update:
                                </b>
                                <p className="text-sm font-semibold mt-1">
                                    {currentEditingItem.updated_by_user?.name ||
                                        'N/A'}
                                </p>
                                <p>
                                    {currentEditingItem.updated_by_user
            ...
            <Container className="h-auto">
                <AdaptiveCard className="h-full" bodyClass="h-full">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 mb-4 gap-4">
                        ...
                        <Card
                            bodyClass="flex gap-2 p-3"
                            className="rounded-md border border-violet-200 dark:border-violet-700"
                        >
                        ...
                        <Card
                            bodyClass="flex gap-2 p-3"
                            className="rounded-md border border-red-200 dark:border-red-700"
                        >
                        ...
                        <Card
                            bodyClass="flex gap-2 p-3"
                            className="rounded-md border border-orange-200 dark:border-orange-700"
                        >
                            <div className="h-12 w-12 rounded-md flex items-center justify-center bg-orange-100 dark:bg-orange-500/20 text-orange-500 dark:text-orange-200">
                                <TbFileSmile size={24} />
                            </div>
                            <div>
                                <h6 className="text-orange-500 dark:text-orange-200">
                                    {jobPostsData?.counts?.views || 0}
                                </h6>
                                <span className="font-semibold text-xs">
                                    Total Views
                                </span>
                        ...
                        >
                            ...
                            <div>
                                <h6 className="text-green-500 dark:text-green-200">
                                    {jobPostsData?.counts?.applicants || 0}
                                </h6>
                                <span className="font-semibold text-xs">
                                    Applicants
                                </span>
                ...
                footer={
                    <div className="text-right w-full">
                        <Button
                            ...
                            className="mr-2"
                            onClick={
                                editingItem ? closeEditDrawer : closeAddDrawer
                            }
                        ...
                        <Button
                            ...
                            disabled={
                                !formMethods.formState.isValid || isSubmitting
                            }
                        >
                            {isSubmitting
                                ? editingItem
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <Select
                                    ...
                                    options={JOB_POST_STATUS_OPTIONS_FORM.map(
                                        (s) => ({
                                            value: s.value,
                                            label: s.label,
                                        }),
