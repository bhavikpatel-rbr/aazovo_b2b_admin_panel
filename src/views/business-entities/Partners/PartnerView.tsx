...
const PartnerProfileHeader = ({ partner }: { partner: ApiSinglePartnerItem }) => {
    ...
    return (
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
                <div>
                    <h4 className="font-bold">({String(partner.id).padStart(5, '0') || ' '}) - {partner.partner_name}</h4>
                    ...
                    <div className="mt-2 flex items-center gap-2">
                        <Tag className={`${getPartnerStatusClass(partner.status)} capitalize`}>{partner.status || ' '}</Tag>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-y-2 gap-x-4 text-sm">
                ...
                <div className="flex items-center gap-2"><TbLicense className='text-gray-400' /><span className="font-semibold">GST Number:</span><span>{partner.gst_number || ' '}</span></div>
                <div className="flex items-center gap-2"><TbLicense className='text-gray-400' /><span className="font-semibold">PAN Number:</span><span>{partner.pan_number || ' '}</span></div>
            </div>
