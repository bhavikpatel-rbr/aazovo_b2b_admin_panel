...
const initialDummyForms: FormItem[] = [
  {
    ...
    department: "Sales & Marketing", // <-- Added department
  ...
  },
  {
    ...
    department: "Technical Support", // <-- Added department
  ...
  },
  {
    ...
    department: "Business Development", // <-- Added department
...
const FormListTable = () => {
  ...
  const handleCloneForm = (form: FormItem) => {
    ...
    const clonedForm: FormItem = {
      ...
      department: form.department ? `${form.department} (Clone)` : "Unassigned", // Clone department
  ...
  const columns: ColumnDef<FormItem>[] = useMemo(
    () => [
          ...
          return (
            <div className="flex flex-col gap-0.5">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <Tag
                  className={`${statusColor[status]} capitalize text-[10px] px-1.5 py-0.5`}
                >
                  {status}
                </Tag>
              </div>
      ...
      },
      {
        ...
        accessorKey: "inquiry_priority", // Can also be 'department' if you want to sort by it primarily
        enableSorting: true,
        size: 280,
        cell: ({ row }) => {
          const {
            ...
            inquiry_status,
            assigned_to,
            department, // <-- Destructure department
            inquiry_description,
          } = row.original;
          return (
            <div className="flex flex-col gap-1 text-xs">
              <div className="flex items-center gap-2">
                <Tag
                  className={`${
                    priorityColors[inquiry_priority] ||
              ...
              {department && ( // <-- Display department if it exists
                <span className="text-gray-700 dark:text-gray-300">
      ...
      },
      {
        ...
        size: 280,
        cell: ({ row }) => {
          const { feedback_status, inquiry_resolution, inquiry_attachments } =
            row.original;
          return (
            <div className="flex flex-col gap-1 text-xs">
              <span className="text-gray-700 dark:text-gray-300">
              ...
              {inquiry_attachments.length === 0 && !inquiry_resolution && (
                <span className="text-gray-500 dark:text-gray-400">
                  No resolution notes or attachments.
                </span>
              )}
            </div>
          );
