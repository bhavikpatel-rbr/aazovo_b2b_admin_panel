...
const FormListSelected = () => {
  ...
  const handleConfirmDelete = () => {
    const newCustomerList = customerList.filter((customer) => {
      return !selectedCustomer.some((selected) => selected.id === customer.id);
    });
    setSelectAllCustomer([]);
    mutate(
      {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      toast.push(<Notification type="success">Message sent!</Notification>, {
...
export default FormListSelected;
