...
const inquiryFilterFormSchema = z.object({
    ...
    filterInquiryStatus: z.array(z.object({ value: z.string(), label: z.string() })).optional(), // For 'New', 'In Progress'
...
const FormListTableTools = () => {
    ...
    const [localFilterCriteria, setLocalFilterCriteria] = useState<InquiryFilterFormData>(
        (contextFilterCriteria as InquiryFilterFormData) || { // Pre-fill from context if available
    ...
    const onClearFilters = () => {
        const defaultFilters: InquiryFilterFormData = { // Define cleared state
            filterInquiryDate: [null, null],
            filterResponseDate: [null, null],
            filterResolutionDate: [null, null],
            filterFollowUpDate: [null, null],
