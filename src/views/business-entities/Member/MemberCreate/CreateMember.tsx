...
const MemberCreate = () => {
  ...
  // const { memberId } = useParams<{ memberId?: string }>(location.state ? location.state.id : undefined);
  const memberId = location.state ? location.state.id : undefined
  const isEditMode = Boolean(location.state ? true : false);

  console.log(location.state, 'location')
  const [initialData, setInitialData] = useState<Partial<MemberFormSchema> | null>(location.state ?? null);
