          ...
          <AdaptiveCard>
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-4 mb-4 gap-2">
                <div onClick={() => handleCardClick('All')} className="cursor-pointer"><Card bodyClass="flex gap-2 p-2" className="rounded-md border border-blue-200"><div className="h-12 w-12 rounded-md flex items-center justify-center bg-blue-100 text-blue-500"><TbUsersGroup size={24} /></div><div><h6 className="text-blue-500">{counts.total}</h6><span className="font-semibold text-xs">Total</span></div></Card></div>
                ...
                <div onClick={() => handleCardClick('Disabled')} className="cursor-pointer"><Card bodyClass="flex gap-2 p-2" className="rounded-md border border-red-200"><div className="h-12 w-12 rounded-md flex items-center justify-center bg-red-100 text-red-500"><TbUserCancel size={24} /></div><div><h6 className="text-red-500">{counts.disabled}</h6><span className="font-semibold text-xs">Disabled</span></div></Card></div>
                <div onClick={() => handleCardClick('Unregistered')} className="cursor-pointer"><Card bodyClass="flex gap-2 p-2" className="rounded-md border border-pink-200"><div className="h-12 w-12 rounded-md flex items-center justify-center bg-pink-100 text-pink-500"><TbUserExclamation size={24} /></div><div><h6 className="text-pink-500">{counts.unregistered}</h6><span className="font-semibold text-xs">Unregistered</span></div></Card></div>
              </div>
