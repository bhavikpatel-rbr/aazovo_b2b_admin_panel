      ...
      <Container className="h-auto">
        <AdaptiveCard className="h-full" bodyClass="h-full flex flex-col">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 mb-6 gap-3">
            ...
            <Tooltip title="Total unique IP addresses"><Card bodyClass="flex gap-2 p-3 items-center" className="rounded-lg border border-violet-300 dark:border-violet-700 cursor-default"><div className="h-12 w-12 rounded-lg flex items-center justify-center bg-violet-100 text-violet-500 dark:bg-violet-500/20 dark:text-violet-300"><TbCloudPin size={24} /></div><div><h6 className="text-violet-500 dark:text-violet-300">{counts.unique_ip ?? "..."}</h6><span className="font-semibold text-xs">Unique IP</span></div></Card></Tooltip>
            <Tooltip title="Total distinct IP addresses"><Card bodyClass="flex gap-2 p-3 items-center" className="rounded-lg border border-orange-200 dark:border-orange-700 cursor-default"><div className="h-12 w-12 rounded-lg flex items-center justify-center bg-orange-100 text-orange-500 dark:bg-orange-500/20 dark:text-orange-300"><TbCloudCog size={24} /></div><div><h6 className="text-orange-500 dark:text-orange-300">{counts.distinact_ip ?? "..."}</h6><span className="font-semibold text-xs">Distinct IP</span></div></Card></Tooltip>
            <Tooltip title="Total suspicious IP addresses"><Card bodyClass="flex gap-2 p-3 items-center" className="rounded-lg border border-red-200 dark:border-red-700 cursor-default"><div className="h-12 w-12 rounded-lg flex items-center justify-center bg-red-100 text-red-500 dark:bg-red-500/20 dark:text-red-300"><TbCloudExclamation size={24} /></div><div><h6 className="text-red-500 dark:text-red-300">{counts.suspicious_ip ?? "..."}</h6><span className="font-semibold text-xs">Suspicious</span></div></Card></Tooltip>
          </div>
