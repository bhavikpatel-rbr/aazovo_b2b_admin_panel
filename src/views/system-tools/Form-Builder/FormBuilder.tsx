...
const [isImageViewerOpen, setImageViewerOpen] = useState(false);
  ...
  const baseColumns: ColumnDef<FormBuilderItem>[] = useMemo(() => [
    ...
    { header: "Type", accessorKey: "is_external", size: 120, cell: (props) => { const isExternal = props.row.original.is_external; return (<Tag className={classNames("capitalize", isExternal ? "bg-sky-100 text-sky-600 dark:bg-sky-500/20 dark:text-sky-100" : "bg-fuchsia-100 text-fuchsia-600 dark:bg-fuchsia-500/20 dark:text-fuchsia-100")}>{isExternal ? "External" : "Internal"}</Tag>); }, },
