...
const initialDummyForms: FormItem[] = [
    { id: 'F001', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active' },
    { id: 'F002', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active'},
    { id: 'F003', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active' },
    { id: 'F004', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active'},
    { id: 'F005', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active'},
    { id: 'F006', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active'},
    { id: 'F007', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active'},
    { id: 'F008', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active'},
    { id: 'F009', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active'},
    { id: 'F010', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active' },
    { id: 'F011', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active'},
    { id: 'F012', continentName: 'Test', countryName: 'test', shortCode: 'US', phoneCode: '+1', status: 'active'},
]
// --- End Dummy Data ---
...
const FormListTable = () => {
        ...
        if (tableData.query) {
            ...
            filteredData = forms.filter(
                (form) =>
                    ...
                    form.continentName.toLowerCase().includes(query) ||
                    form.countryName.toLowerCase().includes(query) ||
                    form.shortCode.toLowerCase().includes(query) ||
                    form.phoneCode.toLowerCase().includes(query) ||
    ...
    const handleCloneForm = (form: FormItem) => {
        ...
        console.log('Cloning form:', form.id, form.continentName)
        ...
        const clonedForm: FormItem = {
            ...form,
            id: newId,
            continentName: `${form.continentName} (Clone)`,
            countryName: `${form.countryName} (Clone)`,
            shortCode: `${form.shortCode} (Clone)`,
            phoneCode: `${form.phoneCode} (Clone)`,
