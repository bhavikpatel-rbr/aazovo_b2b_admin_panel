...
function exportProductSpecificationsToCsv(
    ...
    const transformedRows: ProductSpecificationExportItem[] = rows.map(
        (row) => ({
            id: row.id,
            name: row.name,
            countryNameForExport:
...
const ProductSpecification = () => {
    ...
    const [addFormFlagIconPreviewUrl, setAddFormFlagIconPreviewUrl] = useState<
        string | null
    >(null)
    const [editFormFlagIconPreviewUrl, setEditFormFlagIconPreviewUrl] =
        ...
        try {
            ...
            toast.push(
                <Notification
                    ...
                    duration={2000}
                >
                    Specification "{String(data.name || editingItem.name)}"
                    updated.
                </Notification>,
            )
            closeEditDrawer()
        ...
        if (tableData.query) {
            ...
            processedData = processedData.filter(
                (item) =>
                    ...
                    (item.note_details &&
                        item.note_details.toLowerCase().includes(query)),
            )
        }
            ...
            },
            {
                ...
                cell: (props) => {
                    const countryName =
                        ...
                        props.row.original.country_name
                    return countryName ? (
                            ...
                            <Button
                                ...
                                disabled={
                                    ...
                                    (drawerProps.formId ===
                                        ...
                                        !drawerProps.formMethods.formState
                                            .isDirty &&
                                        !drawerProps.formMethods.getValues(
                                            'flag_icon',
                                        ))
                                }
                            >
                ...
                >
                    ...
                    >
                                ...
                                render={({
                                    ...
                                    <Input
                                        ...
                                        onChange={(
                                            ...
                                            if (file)
                                                drawerProps.formMethods.trigger(
                                                    'flag_icon',
                                                )
                                        }}
                        ...
                        <FormItem
                            ...
                            errorMessage={
                                drawerProps.formMethods.formState.errors
                                    .note_details?.message as string | undefined
                            }
                        >
                            <Controller
                                name="note_details"
