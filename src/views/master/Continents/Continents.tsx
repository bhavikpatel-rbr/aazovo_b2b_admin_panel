    ...
    return (
        <div className="md:flex items-center justify-between w-full gap-2">
            ...
            <div className="flex gap-2">
                ...
                <Button icon={<TbCloudUpload />} menuName="continents" isExport={true} onClick={onExport} disabled={!isDataReady}>Export</Button>
            </div>
                ...
                <AdaptiveCard className="h-full" bodyClass="h-full flex flex-col">
                    <div className="lg:flex items-center justify-between mb-4">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-2">
                            <Button variant="solid" menuName="continents" isAdd={true} icon={<TbPlus />} onClick={openAddDrawer} className="w-full sm:w-auto mt-2 sm:mt-0">Add Continent</Button>
                        </div>
                    </div>
                    ...
                    <div className=" grid grid-cols-2 text-xs bg-gray-100 dark:bg-gray-700 p-2 rounded mt-3">
                        <div>
                            ...
                            <p className="text-sm font-semibold">
                                {editingContinent.updated_by_user?.name || " "}
                            </p>
                            <p>
