...
const FormListTable = () => {
        ...
        if (tableData.query) {
            ...
            filteredData = forms.filter(
                (form) =>
                    ...
                    form.image.toLowerCase().includes(query) ||
                    form.domain.toLowerCase().includes(query) ||
                    form.displayPage.toLowerCase().includes(query) ||
                    form.link.toLowerCase().includes(query) ||
    ...
    const handleCloneForm = (form: FormItem) => {
        ...
        console.log('Cloning form:', form.id, form.image)
        ...
        const clonedForm: FormItem = {
            ...
            displayPage: `${form.displayPage} (Clone)`,
