...
const initialDummyForms: FormItem[] = [
    { id: 'F001', formName: 'User Registration', status: 'active' },
    { id: 'F002', formName: 'Contact Us', status: 'active' },
    { id: 'F003', formName: 'Product Feedback V1', status: 'inactive' },
    { id: 'F004', formName: 'Support Ticket', status: 'active' },
    { id: 'F005', formName: 'Newsletter Signup', status: 'active' },
    { id: 'F006', formName: 'Job Application', status: 'inactive' },
    { id: 'F007', formName: 'Event RSVP', status: 'active' },
    { id: 'F008', formName: 'Password Reset', status: 'active' },
    { id: 'F009', formName: 'Feature Request', status: 'inactive' },
    { id: 'F010', formName: 'Beta Program Signup', status: 'active' },
    { id: 'F011', formName: 'Onboarding Checklist', status: 'active' },
    {
        id: 'F012',
...
const FormListTable = () => {
    ...
    const handleCloneForm = (form: FormItem) => {
        ...
        console.log('Cloning form:', form.id, form.formName)
