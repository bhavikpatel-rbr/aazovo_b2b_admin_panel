...
export type FormItem = {
    ...
    currencyCode?: string // Optional field for currency code
...
const initialDummyForms: FormItem[] = [
    { id: 'F001', currencySymbol: '₹', currencyCode: 'INR', status: 'active' },
    { id: 'F002', currencySymbol: '₹', currencyCode: 'INR', status: 'active'},
    { id: 'F003', currencySymbol: '₹', currencyCode: 'INR', status: 'active' },
    { id: 'F004', currencySymbol: '₹', currencyCode: 'INR', status: 'active'},
    { id: 'F005', currencySymbol: '₹', currencyCode: 'INR', status: 'active'},
    { id: 'F006', currencySymbol: '₹', currencyCode: 'INR', status: 'active'},
    { id: 'F007', currencySymbol: '₹', currencyCode: 'INR', status: 'active'},
    { id: 'F008', currencySymbol: '₹', currencyCode: 'INR', status: 'active'},
    { id: 'F009', currencySymbol: '₹', currencyCode: 'INR', status: 'active'},
    { id: 'F010', currencySymbol: '₹', currencyCode: 'INR', status: 'active' },
    { id: 'F011', currencySymbol: '₹', currencyCode: 'INR', status: 'active'},
    {
        id: 'F012',
        currencySymbol: '₹', currencyCode: 'INR', status: 'active',
    },
]
// --- End Dummy Data ---
...
const FormListTable = () => {
        ...
        if (tableData.query) {
            ...
            filteredData = forms.filter(
                (form) =>
                    ...
                    form.currencySymbol.toLowerCase().includes(query) ||
    ...
    const handleCloneForm = (form: FormItem) => {
        ...
        console.log('Cloning form:', form.id, form.currencySymbol)
        ...
        const clonedForm: FormItem = {
            ...form,
            id: newId,
            currencySymbol: `${form.currencySymbol} (Clone)`,
            currencyCode: `${form.currencySymbol} (Clone)`, // Assuming currencyCode is same as currencySymbol
