...
const TrendingImages = () => {
    ...
    const onAddItemSubmit = async (data: TrendingPageImageFormData) => { setIsSubmitting(true); try { const payload = { ...data, product_ids: data.trendingProducts?.map(Number)
