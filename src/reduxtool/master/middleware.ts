...
export const getAllActionAction = createAsyncThunk(
  ...
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getAllActionActionAsync()
      if (response) {
        return response
      }
