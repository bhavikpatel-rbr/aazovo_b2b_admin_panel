...
import { addaccountdocActionAsync, addAlertsActionAsync, addAllActionActionAsync, addAutoEmailAsync, addAutoEmailTemplatesAsync, addBlogsAsync, addBrandAsync, addBugReportAsync, addcategoryAsync, addCompanyAsync, addcontinentAsync, addcountryAsync, addCurrencyAsync, addDemandAsync, addDepartmentAsync, addDesignationAsync, addDocumentListAsync, addDocumentTypeAsync, addDomainsAsync, addEmailCampaignsAsync, addEmailTemplatesAsync, addEmployeeListAsync, addFormBuilderAsync, addHomeCategoryAsync, addInquiriesAsync, addJobApplicationAsync, addJobDepartmentAsync, addJobPostsAsync, addLeadAsync, addMemberAsync, addMemberTypeAsync, addNotificationAsync, addNumberSystemsAsync, addOfferAsync, addPageAsync, addpartnerAsync, addPaymentTermAsync, addPinnedTabAsync, addPriceListAsync, addProductAsync, addProductSepecificationAsync, addRequestFeedbacksAsync, addRolesAsync, addRowDataAsync, addScheduleAsync, addSlidersAsync, addSubscriberAsync, addTaskListAsync, addTrandingCarouselAsync, addTrandingImageAsync, addUnitAsync, addupdatePermissionsAsync, addWallItemAsync, apiGetEmployeeByIdAsync, blockUserAsync, changeProductStatusAsync, deletBlogsAsync, deletBrandListAsync, deletBugReportAsync, deletcategoryListAsync, deletcompanyAsync, deletcontinentAsync, deletcountryAsync, deletCurrencyAsync, deletDepartmentAsync, deletDesignationAsync, deletDocumentListAsync, deletDocumentTypeAsync, deletDomainsAsync, deleteAllActionActionAsync, deleteAllAutoEmailAsync, deleteAllAutoEmailTemplatesAsync, deleteAllBlogsAsync, deleteAllBrandListAsync, deleteAllBugReportAsync, deleteAllcategoryListAsync, deleteAllcompanyAsync, deleteAllcontinentAsync, deleteAllcountryAsync, deleteAllCurrencyAsync, deleteAllDemandAsync, deleteAllDepartmentAsync, deleteAllDesignationAsync, deleteAllDocumentListAsync, deleteAllDocumentTypeAsync, deleteAllEmailCampaignsAsync, deleteAllEmailTemplatesAsync, deleteAllExportMappingsAsync, deleteAllFormBuilderAsync, deleteAllHomeCategoryAsync, deleteAllInquiriesAsync, deleteAllJobApplicationAsync, deleteAllJobDepartmentAsync, deleteAllJobPostsAsync, deleteAllLeadAsync, deleteAllMemberAsync, deleteAllNumberSystemsAsync, deleteAllOfferAsync, deleteAllPageAsync, deleteAllpartnerAsync, deleteAllPaymentTermAsync, deleteAllPriceListAsync, deleteAllProductSepecificationAsync, deleteAllRequestFeedbacksAsync, deleteAllRolesAsync, deleteAllRowDataAsync, deleteAllSlidersListAsync, deleteAllTrandingCarouselAsync, deleteAllTrandingImageAsync, deleteAllUnitAsync, deleteAllWallAsync, deleteAutoEmailAsync, deleteAutoEmailTemplatesAsync, deleteDemandAsync, deleteDomainsAsync, deleteEmailCampaignsAsync, deleteEmailTemplatesAsync, deleteFormBuilderAsync, deleteJobApplicationAsync, deleteLeadAsync, deleteMemberAsync, deleteOfferAsync, deletePageAsync, deletepartnerAsync, deletePriceListAsync, deleteRequestFeedbacksAsync, deleteRolesAsync, deleteTaskAsync, deletHomeCategoryAsync, deletJobDepartmentAsync, deletJobPostsAsync, deletNumberSystemsAsync, deletPaymentTermAsync, deletProductListAsync, deletProductSepecificationAsync, deletRowDataAsync, deletSlidersListAsync, deletTrandingCarouselAsync, deletTrandingImageAsync, deletUnitAsync, editaccountdocActionAsync, editAutoEmailAsync, editAutoEmailTemplatesAsync, editBlogsAsync, editBrandListAsync, editBugReportAsync, editcategoryListAsync, editCompanyAsync, editCompanyProfileListAsync, editcontinentAsync, editcountryAsync, editCurrencyAsync, editDemandAsync, editDepartmentAsync, editDesignationAsync, editDocumentListAsync, editDocumentTypeAsync, editDomainsAsync, editEmailCampaignsAsync, editEmailTemplatesAsync, editEmployeeListAsync, editFormBuilderAsync, editGlobalSettingAsync, editHomeCategoryAsync, editInquiriesAsync, editJobApplicationAsync, editJobDepartmentAsync, editJobPostsAsync, editLeadAsync, editMemberAsync, editMemberTypeAsync, editNumberSystemsAsync, editOfferAsync, editPageAsync, editpartnerAsync, editPaymentTermAsync, editPriceListAsync, editProductListAsync, editProductSepecificationAsync, editRequestFeedbacksAsync, editRolesAsync, editRowDataAsync, editSlidersListAsync, editSubscriberAsync, editTaskListAsync, editTrandingCarouselAsync, editTrandingImageAsync, editUnitAsync, editWallAsync, getaccountdocActionAsync, getAccountDocByIdAsync, getActivityLogAsync, getActualCompanyAsync, getAlertsActionAsync, getAllActionActionAsync, getAllCategoriesData, getAllCompanyAsync, getAllDocumentsAsync, getAllNotificationAsync, getAllproductAsync, getAllProductsAsync, getAllProductsDataAsync, getAllScheduleAsync, getAllTaskAsync, getAllTaskByStatuesAsync, getAllUsersAsync, getAutoEmailAsync, getAutoEmailTemplatesAsync, getAutoMatchDataAsync, getAutoSpbAsync, getBlogsAsync, getBrandAsync, getBugReportAsync, getBuyerListingsAsync, getbyIDaccountdocActionAsync, getcategoryAsync, getcompanyAsync, getCompanyByIdAsync, getCompanyProfileAsync, getcontinentAsync, getcountryAsync, getCurrencyAsync, getDashboardAccountDocAsync, getDashboardCompanyAsync, getDashboardCountsAsync, getDashboardLeadsAsync, getDashboardMemberAsync, getDashboardOpportunityAsync, getDashboardPartnerAsync, getDashboardProductAsync, getDashboardTaskAsync, getDashboardTeamsAsync, getDashboardWallAsync, getDemandByIdAsync, getDemandsAsync, getDepartmentAsync, getDesignationAsync, getDocumentListAsync, getDocumentTypeAsync, getDomainsAsync, getEmailCampaignsAsync, getEmailTemplatesAsync, getEmployeeAsync, getEmployeeListAsync, getExportMappingsAsync, getFilledFormAsync, getFillUpFormAsync, getFormBuilderAsync, getfromIDcompanymemberActionAsync, getGlobalSettingAsync, getHomeCategoryAsync, getInquiriesAsync, getJobApplicationAsync, getJobDepartmentAsync, getJobPostsAsync, getLeadAsync, getLeadByIdAsync, getLeadMemberAsync, getMailTemplatesAsync, getmatchopp, getMemberAsync, getMemberByIdAsync, getMemberlistAsync, getMembersAsync, getMemberTypeAsync, getNotificationAsync, getNumberSystemsAsync, getOfferByIdAsync, getOffersAsync, getOpportunitiesAsync, getOpportunitieslistAsync, getPageAsync, getParentcategoryAsync, getpartnerAsync, getpartnerByIdAsync, getPaymentTermAsync, getpendingbiling, getPinnedTabsAsync, getPriceListAsync, getProductAsync, getProductByIdAsync, getProductPriceAsync, getProductSepecificationAsync, getProductslistAsync, getpWallListingAsync, getReportingToAsync, getRequestFeedbacksAsync, getRolesAsync, getRowDataAsync, getSalesPersonAsync, getSellerListingsAsync, getSlidersAsync, getStartProcessAsync, getSubcategoriesByCategoryIdAsync, getSubcategoriesByIdAsync, getSubscribersAsync, getSuppliersAsync, getTrandingCarouseAsync, getTrandingImageAsync, getUnitAsync, getUsersAsync, getviewopp, getWallItemByIdAsync, getwallListingAsync, importRowDataAsync, removePinnedTabAsync, sendCampaignNowAsync, setenablebilling, setsavedoc, submitFillUpFormAsync, submitResponseAsync, submitStartProcessAsync, updateTaskStatusAsync } from "./services";
...
export const updatePermissionsAction = createAsyncThunk<any, any>(
  "auth/updatePermissionsAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await addupdatePermissionsAsync(data)
      if (response?.data?.status === true) {
...
export const getPageAction = createAsyncThunk("auth/Page",
  async (_, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getPageAsync()
      if (response?.data?.status === true) {
        return response?.data
      }
...
export const addPageAction = createAsyncThunk<any, any>("auth/pageadd",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      ...
      if (response?.data?.status === true) {
        ...
        return rejectWithValue({
          message: response?.message || 'Failed to edit page.'
        });
      }
    } catch (error: unknown) {
      return rejectWithValue(error as Error)
...
export const editPageAction = createAsyncThunk<any, any>("auth/editPage",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await editPageAsync(data)
      if (response?.status === true || response?.status === 200) {
        dispatch(getPageAction())
        return response?.data
      } else {
...
export const deletePageAction = createAsyncThunk<any, any>("auth/deletePage", // Corrected: "deletMember"
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await deletePageAsync(data)
      if (response?.data?.status === true) {
        dispatch(getMemberAction())
...
export const deleteAllPageAction = createAsyncThunk<any, any>(
  "auth/deleteAllPage",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<{ status: boolean; data: any; message?: string }> = await deleteAllPageAsync(data)
      if (response?.data?.status === true) {
        dispatch(getPageAction())
...
export const getProductById = createAsyncThunk(
  ...
  async (id: string | number, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getProductByIdAsync(id);
      if (response?.data?.status) {
        return response?.data?.data;
      }
...
export const getOpportunitieslistingAction = createAsyncThunk(
...
export const getProductPriceAction = createAsyncThunk(
  ...
  async (id: string | number, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getProductPriceAsync(id);
      if (response?.data.status) {
        return response.data.data;
      }
...
export const getActualCompanyAction = createAsyncThunk(
  "auth/getActualCompanyAction",
  async (id: string | number, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getActualCompanyAsync(id);
      if (response?.data?.status) {
        return response?.data?.data;
      }
...
export const getDashboardCompanyAction = createAsyncThunk(
  "auth/getDashboardCompanyAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getDashboardCompanyAsync();
      if (response?.data) {
        return response?.data?.data;
      }
...
export const getDashboardMemberAction = createAsyncThunk(
  "auth/getDashboardMemberAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getDashboardMemberAsync();
      if (response?.data) {
        return response?.data?.data;
      }
...
export const getDashboardProductAction = createAsyncThunk(
  "auth/getDashboardProductAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getDashboardProductAsync();
      if (response?.data) {
        return response?.data?.data;
      }
...
export const getDashboardPartnerAction = createAsyncThunk(
  "auth/getDashboardPartnerAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getDashboardPartnerAsync();
      if (response?.data) {
        return response?.data?.data;
      }
...
export const getDashboardTeamsAction = createAsyncThunk(
  "auth/getDashboardTeamsAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getDashboardTeamsAsync();
      if (response?.data) {
        return response?.data;
      }
...
export const getDashboardLeadsAction = createAsyncThunk(
  "auth/getDashboardLeadsAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getDashboardLeadsAsync();
      if (response?.data) {
        return response?.data;
      }
...
export const getDashboardTaskAction = createAsyncThunk(
  "auth/getDashboardTaskAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getDashboardTaskAsync();
      if (response?.data) {
        return response?.data;
      }
...
export const getDashboardOpportunityAction = createAsyncThunk(
  "auth/getDashboardOpportunityAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getDashboardOpportunityAsync();
      if (response?.data) {
        return response?.data;
      }
...
export const getDashboardWallAction = createAsyncThunk(
  "auth/getDashboardWallAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getDashboardWallAsync();
      if (response?.data) {
        return response?.data;
      }
...
export const getDashboardAccountDocAction = createAsyncThunk(
  "auth/getDashboardAccountDocAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getDashboardAccountDocAsync();
      if (response?.data) {
        return response?.data;
      }
...
export const apiGetEmployeeById = createAsyncThunk(
  ...
  async (id, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await apiGetEmployeeByIdAsync(id);
      if (response) {
        return response;
      }
...
export const getAllUsersAction = createAsyncThunk<any>(
  ...
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getAllUsersAsync()
      if (response) {
        return response
      }
...
export const getAllScheduleAction = createAsyncThunk<any, any>(
  "auth/getAllScheduleActions",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getAllScheduleAsync()
      if (response) {
        return response
      }
...
export const addScheduleAction = createAsyncThunk<any, any>(
  "auth/addScheduleAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
...
export const getAutoSpbAction = createAsyncThunk(
  "auth/getAutoSpbAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getAutoSpbAsync()
      if (response) {
        return response
      }
...
export const blockUserAction = createAsyncThunk<any, any>(
  ...
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await blockUserAsync(data)
      if (response) {
        dispatch(getActivityLogAction());
        return response
      }
...
export const getPinnedTabAction = createAsyncThunk<any>(
  'pinnedTabs/get', // Action type prefix
  async (_, { rejectWithValue }) => {
    try {
      const response: AxiosResponse<any> = await getPinnedTabsAsync();
      if (response) {
        // Return the array of pinned tabs
        return response;
      }
      return rejectWithValue(response);
    } catch (error: unknown) {
...
/**
 * @description Action to add a new pinned tab.
 */
export const addPinnedAction = createAsyncThunk<any, any>(
  'pinnedTabs/add', // Action type prefix
  async (data, { rejectWithValue, dispatch }) => {
    try {
...
/**
 * @description Action to remove a pinned tab.
 */
export const removePinnedAction = createAsyncThunk<any, any>(
  'pinnedTabs/remove', // Action type prefix
  async (data, { rejectWithValue, dispatch }) => {
    try {
...
export const getAllDocumentsAction = createAsyncThunk<any, any>(
  "getAllDocumentsAsync",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getAllDocumentsAsync()
      if (response) {
        return response
      }
...
export const getAllActionAction = createAsyncThunk(
  "auth/getAllActionAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getAllActionActionAsync(data)
      if (response) {
        return response
      }
...
export const getAlertsAction = createAsyncThunk(
  "auth/getAlertsAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getAlertsActionAsync(data)
      if (response) {
        return response
      }
...
export const addAllAlertsAction = createAsyncThunk(
  "auth/addEditAllAlertsAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await addAlertsActionAsync(data)
      if (response?.status === true) {
        return response
      } else {
        return rejectWithValue({
...
export const addAllActionAction = createAsyncThunk(
  "auth/addEditAllActionAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
...
export const deleteAllActionAction = createAsyncThunk(
  "auth/deleteAllActionAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await deleteAllActionActionAsync(data)
      if (response) {
        return response
      }
...
export const deleteTaskAction = createAsyncThunk<any, any>(
  "auth/deleteTaskAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await deleteTaskAsync(data)
      if (response?.data?.status === true) {
        dispatch(getAllTaskAction())
...
export const getaccountdocAction = createAsyncThunk(
  "auth/getaccountdocAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getaccountdocActionAsync()
      if (response) {
        return response
      }
...
export const addaccountdocAction = createAsyncThunk(
  "auth/addaccountdocAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await addaccountdocActionAsync(data)
      if (response) {
        return response
      }
...
export const editaccountdocAction = createAsyncThunk(
  "auth/editaccountdocAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {

      const response: AxiosResponse<any> = await editaccountdocActionAsync(data)
      if (response) {
        return response
      }
...
export const getbyIDaccountdocAction = createAsyncThunk(
  "auth/gettaccountdocAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getbyIDaccountdocActionAsync(data)
      if (response) {
        return response
      }
...
export const getfromIDcompanymemberAction = createAsyncThunk(
  "auth/getfromIDcompanymemberAction",
  async (id, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getfromIDcompanymemberActionAsync(id)
      if (response) {
        return response?.data
      }
...
export const getAccountDocByIdAction = createAsyncThunk(
  "master/getAccountDocByIdAction",
  async (id: string, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getAccountDocByIdAsync(id)
      if (response?.data?.status === true) {
        return response?.data?.data
      }
...
export const getFilledFormAction = createAsyncThunk(
  "auth/getFilledFormAction",
  async (id, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getFilledFormAsync(id)
      if (response) {
        return response?.data
      }
...
export const submitStartProcessAction = createAsyncThunk(
  "auth/submitStartProcessAction",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await submitStartProcessAsync(data)
      if (response) {
        return response
      }
...
export const getLeadByIdAction = createAsyncThunk(
  "master/getLeadByIdAction",
  async (id: string, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getLeadByIdAsync(id)
      if (response?.data?.status === true) {
...
export const getStartProcessAction = createAsyncThunk(
  "auth/getStartProcessAction",
  async (id, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await getStartProcessAsync(id)
      if (response) {
        return response?.data
      }
...
export const setsavedocAction = createAsyncThunk(
  "auth/setsavedocAction", async (data, { rejectWithValue, dispatch }) => {
    try {
      const response: AxiosResponse<any> = await setsavedoc(data.id, data.data)
      if (response) {
        return response?.data
      }
...
export const getMatchingOpportunitiesAction = createAsyncThunk("auth/getAllmatchoppAction", async (id, { rejectWithValue, dispatch }) => {
  try {
    const response: AxiosResponse<any> = await getmatchopp(id)
    if (response) {
      return response
    }
    return rejectWithValue(response)
...
export const getLeadOpportunitiesAction = createAsyncThunk("auth/getAllmatchoppAction", async (data, { rejectWithValue, dispatch }) => {
  try {
    const response: AxiosResponse<any> = await getviewopp(data.id, data.key)
    if (response) {
      return response
    }
    return rejectWithValue(response)
