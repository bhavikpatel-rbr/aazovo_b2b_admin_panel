...
export const addMemberAction = createAsyncThunk<any, any>(
  "auth/addMember",
  async (data, { rejectWithValue, dispatch }) => {
    try {
      console.log("data", data);
