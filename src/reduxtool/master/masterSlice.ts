...
const masterSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getDashboardMemberAction.fulfilled, (state, { payload }) => ({
      ...state,
      DashboardMemberData: payload,
    }));
    builder.addCase(getDashboardProductAction.fulfilled, (state, { payload }) => ({
      ...state,
      DashboardProductData: payload,
    }));
    builder.addCase(getDashboardPartnerAction.fulfilled, (state, { payload }) => ({
      ...state,
      DashboardPartnerData: payload,
    }));
    ...
    builder.addCase(getDashboardTaskAction.fulfilled, (state, { payload }) => ({
      ...state,
      DashboardTaskData: payload,
    }));
    builder.addCase(getDashboardOpportunityAction.fulfilled, (state, { payload }) => ({
      ...state,
      DashboardOpportunityData: payload,
    }));
