    ...
    >
      <div className="flex items-center justify-between p-4">
        <div className={cn("flex items-center", collapsed && "justify-center w-full")}>
          {!collapsed && (
            <span className="text-xl font-bold text-sidebar-foreground">
              Trade<span className="text-primary">Nexus</span>
            </span>
          )}
        ...
        <Button 
          ...
          className={cn("absolute -right-3 top-6 bg-primary text-primary-foreground rounded-full h-6 w-6 p-1 z-10", 
      ...
      <div className="px-3 py-2">
        <nav className="space-y-1">
          ...
          <div className={cn("text-xs text-sidebar-foreground/70 font-medium mb-2 mt-4", 
