...
const AddTaskModal = ({
    ...
    // A helper for creating icon-enhanced labels
    const FormLabel = ({ icon, children }: { icon: JSX.Element, children: React.ReactNode }) => (
    ...
    return (
        ...
        >
            <div className="p-6">
                <h5 className="mb-6">Add New Task</h5>
                <Form onSubmit={handleSubmit(onSubmit)}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8">
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <Input
                                            ...
                                            {...field}
                                            rows={8}
                                            placeholder="Provide a detailed description of the task, including any necessary steps or context..."
                                        />
                                    )}
                                />
                            </FormItem>
                        ...
                        <div className="space-y-6 mt-6 md:mt-0">
                             <FormItem
                                label={<FormLabel icon={<HiOutlineOfficeBuilding />}>Company</FormLabel>}
                            ...
                            <FormItem
                                label={<FormLabel icon={<HiOutlineUserGroup />}>Assign To</FormLabel>}
                            ...
                            >
                             ...
                             <FormItem
                                label={<FormLabel icon={<HiOutlineFlag />}>Priority</FormLabel>}
                            ...
                            <FormItem
                                label={<FormLabel icon={<HiOutlineCalendar />}>Due Date</FormLabel>}
...
const _Tasks = ({ className }: { className?: string }) => {
    ...
    return (
        <>
            ...
            <AddTaskModal isOpen={addTaskModalIsOpen} onClose={() => setAddTaskModalIsOpen(false)} onTaskAdd={handleConfirmAddTask} employeeOptions={employeeOptions} companyOptions={companyOptions}/>
